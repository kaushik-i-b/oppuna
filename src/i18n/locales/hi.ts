...
export const hi: DeepPartial<Translation> = {
  ...
  settings: {
    ...
    themeDark: 'गहरा',
    themeSystem: 'सिस्टम',
    aiModel: 'डिवाइस पर एआई साथी',
    aiModelDescription: 'निजी चैट चलाने वाला Llama मॉडल डाउनलोड करें।',
  },
  aiModel: {
    title: 'डिवाइस पर एआई',
    intro:
      'Oppuna आपके फ़ोन पर सीधे एक छोटा Llama मॉडल चला सकता है ताकि बातचीत अधिक गर्म और स्वाभाविक हो। आप जो कुछ भी लिखते हैं वह आपके डिवाइस पर ही रहता है — मॉडल आपके शब्द कहीं नहीं भेजता।',
    privacyNote:
      'मॉडल एक बार किसी भरोसेमंद स्रोत से डाउनलोड होता है। कोई खाता नहीं, कोई ट्रैकिंग नहीं, और कोई भी व्यक्तिगत डेटा आपके फ़ोन से बाहर नहीं जाता। डाउनलोड के बाद आप इसे पूरी तरह ऑफ़लाइन, हवाई जहाज़ मोड में भी उपयोग कर सकते हैं।',
    statusLabel: 'स्थिति',
    statusReady: 'इंस्टॉल हो गया',
    statusDownloading: 'डाउनलोड हो रहा है…',
    statusNotInstalled: 'इंस्टॉल नहीं है',
    download: 'मॉडल डाउनलोड करें',
    downloadComplete: 'डिवाइस पर एआई तैयार है।',
    ...
    delete: 'मॉडल हटाएँ',
    deleted: 'मॉडल हटा दिया गया।',
    deleteConfirm: 'इससे स्टोरेज खाली होगा। आप इसे कभी भी फिर से डाउनलोड कर सकते हैं।',
  },
  chat: {
    modelEnable: 'सक्षम करें',
    modelEnableHint: 'डिवाइस पर एआई सेटअप खोलता है',
  },
  lock: {
    title: 'Oppuna लॉक है',
