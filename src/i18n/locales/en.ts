export const en = {
  ...
  home: {
    ...
    wellnessSubtitle: 'Your private daily wellness plan lives here.',
    wellnessScore: 'Wellness score',
    streak: 'Care streak',
    dayStreak: 'days showing up',
    todaysPlan: 'Today’s plan',
    continuePlan: 'Continue plan',
    whyPlan: 'Why this plan?',
    moodCheckIn: 'Mood check-in',
    moodTrend: 'Weekly avg',
    recentAchievement: 'Recent achievement',
    achievementPlanDone: 'You completed today’s wellness plan.',
    achievementStreak: 'You’ve shown up {n} days in a row.',
    achievementStart: 'Complete one plan activity to start a streak.',
    nextReminder: 'Gentle reminders',
    reminderHint: 'Morning and evening nudges stay on this device when enabled in Profile.',
  ...
  plan: {
    ...
    completeAll: 'Mark plan complete',
    allDone: 'Nice work — today’s plan is complete.',
    why: 'Why this plan?',
    hideWhy: 'Hide explanation',
    openTool: 'Open guided tool',
  },
  chat: {
    title: 'Companion',
    placeholder: 'Share what’s on your mind…',
    intro:
      'Hey — I’m here to support your wellness plan. Everything stays on your phone. What’s on your mind?',
    ...
    kannadaComingSoon:
      'Kannada AI chat will be available soon. You can still chat with guided support for now.',
  },
  mood: {
    title: 'How are you?',
    intensity: 'Intensity',
  ...
  journal: {
    ...
    bodyPlaceholder: 'What happened today?',
    saved: 'Entry saved',
  ...
  settings: {
    ...
    editProfileSubtitle: 'Name, feelings, goals, and daily time',
    aiEngine: 'AI Engine',
    appearance: 'Appearance',
    preferences: 'Preferences',
    privacyHub: 'Private by design',
    privacyHubBody:
    ...
    careReminders: 'Wellness reminders',
    ...
    careRemindersEnabled: 'Reminders on — morning plan + evening check-in.',
    careRemindersDisabled: 'Reminders off.',
    ...
    premiumComingSoon: 'Premium plans are not available yet.',
    about: 'About Oppuna',
    themeLight: 'Light',
    themeDark: 'Dark',
    themeSystem: 'System',
  ...
  insights: {
    ...
    wellnessScore: 'Wellness score',
    encouragement:
      'Small consistent steps matter more than perfect days. Your plan is private and waits when you are ready.',
  },
  lock: {
